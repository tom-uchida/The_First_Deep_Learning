...
#### 重みの勾配 $\frac{\partial E}{\partial w_{jk}}$ の求め方
...
#### バイアスの勾配 $\frac{\partial E}{\partial b_k}$ の求め方
...
$$
\partial y_j = \sum_{r=1}^{n} \delta_r w_jr．
$$

- $\partial y_j$ を $\delta_r$ と $w_jr$ の総和としてシンプルな形にまとめることができた．

<br>

### 5.5.5 中間層の勾配
- $w_ij$ を中間層の重み，$b_j$ をバイアス，$u_j$ を重みと入力の積にバイアスを加えた値とする．また，入力層の出力を $y_i$ とする．
